        ...
        if (!gameMaster.isPaused && Target)
        {
            ...
            switch (cameraState)
            {
                ...
                case (int)cameraStates.freeCam:
                    ...
                    float movAngle = (cameraXSpeed * cameraVertical * gameMaster.cameraYInvert * gameMaster.cameraSensitivity * Time.deltaTime);                            // How far to move (in degrees)
